...
def main():
    ...
    window.bind('<w>', keys.lookUp)
    window.bind('<a>', keys.lookLeft)
    window.bind('<s>', keys.lookDown)
    window.bind('<d>', keys.lookRight)
    window.bind('<Up>', keys.moveFoward)
    window.bind('<Left>', keys.turnLeft)
    window.bind('<Down>', keys.moveBackwards)
    window.bind('<Right>', keys.turnRight)
    window.bind('<space>', keys.defualtMotors)
    ...
    window.bind("d", robot_animations.lookRight)
    window.bind("<Left>", robot_animations.walkLeft)
    window.bind("<Up>", robot_animations.walkRight)
    window.bind("<Down>", robot_animations.bodyIdle)
